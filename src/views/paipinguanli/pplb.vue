<template>
	<section>
		...
		<el-col :span="24" class="toolbar" style="padding-bottom: 0px;font-size:12px;">
			<el-form :inline="true" :model="filters">
				<h4>操作提示：</h4>
					<p>列表显示拍品编号、拍品描述、截至时间、卖家等相关信息</p>
					<p>可以查看拍卖详情，以及查看加价记录</p>
		...
		<el-table :data="tableData" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
	       ...
	       <el-table-column prop="seller" label="拍品描述" sortable>
	       </el-table-column>
	       <el-table-column prop="buyder" label="拍品分类" sortable>
	       </el-table-column>
	       <el-table-column prop="orderTotal" label="截止时间" sortable>
	       </el-table-column>
	       <el-table-column prop="show" label="卖家">
	       </el-table-column>
	       <el-table-column prop="qipaijia" label="起拍价">
	       </el-table-column>
	       <el-table-column prop="jiajia" label="加价">
	       </el-table-column>
